...
class Student(models.Model):
    ...
    enrollment_year = models.PositiveIntegerField(help_text="Year of admission")
    academic_program = models.CharField(max_length=20, choices=ACADEMIC_PROGRAM_CHOICES)
    current_year = models.PositiveSmallIntegerField(help_text="Current year in the program")
