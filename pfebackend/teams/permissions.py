...
# class IsTeamMember(permissions.BasePermission):
#     """
#     Permission to only allow members of a team to access it.
#     """
#     def has_object_permission(self, request, view, obj):
#         # Check if user is a member of the team
#         if isinstance(obj, Team):
...
# class IsTeamOwner(permissions.BasePermission):
#     """
#     Permission to only allow owners of a team to modify it.
#     """
#     def has_object_permission(self, request, view, obj):
...
# class IsInvitationRecipient(permissions.BasePermission):
#     """
#     Permission to only allow the recipient of an invitation to respond to it.
#     """
#     def has_object_permission(self, request, view, obj):
#         return obj.invitee == request.user