...
class TeamService:
    ...
    def create_team(name, description, owner):
        ...
        Args:
            ...
            owner (User): User who will be the team owner
...
# def create_team_invitation(team, inviter, invitee):
#     """
...
#     """
#     Accept a team invitation and create team membership
    
#     Args:
#         invitation (TeamInvitation): The invitation to accept
        
#     Returns:
#         TeamMembership: The created team membership
#     """
#     with transaction.atomic():
#         # Update invitation status
#         invitation.status = TeamInvitation.STATUS_ACCEPTED
...
#     Args:
#         invitation (TeamInvitation): The invitation to decline
#     """
#     invitation.status = TeamInvitation.STATUS_DECLINED
#     invitation.save()
#     return invitation